...
export default function Residential() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const querySnapshot = await getDocs(collection(db, "Residential"));
      const data = [];
  ...
  return (
    <div className="bg-white h-full">
      <img
        ...
        src="https://images.unsplash.com/photo-1628744448839-a475cc0e90c3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt="nature image"
      />
      {/* Add Search Bar */}
      ...
      <div className="flex flex-col items-center h-full bg-opacity-50 mt-10">
        ...
        <p className="text-gray-700 text-md mt-4 font-light">
          We have a wide range of Residential properties to suit your needs.
        </p>

        <div className="flex flex-row justify-end mt-10 sm:mx-20 lg:mx-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:mx-20 mt-10 lg:gap-5 sm:gap-5">
          {filteredData
            .filter((item) =>
